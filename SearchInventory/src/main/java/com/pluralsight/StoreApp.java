...
public class StoreApp {
    ...
    /**
     * prompt user for price range(min, max)
     * if found, display product details for all matches and then return
     * if not found, display product could not be found
      */
    ...
    /**
     * prompt user for PoductID, ProductName and ProductPrice
     * Create product and add it to ArrayList
     */
